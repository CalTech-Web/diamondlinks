            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/25 text-blue-400 text-xs font-semibold uppercase tracking-widest px-4 py-2 rounded-full mb-6">
                  ...
                  Case Study &middot; Cybersecurity
                </div>
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] tracking-tight mb-6">
                  ...
                  >
                    1,025% Organic Traffic Growth
                  </span>
                </h1>

                <p className="text-gray-300 text-lg leading-relaxed mb-8">
                  How DiamondLinks transformed a cybersecurity leader&apos;s organic search presence through strategic SEO, earning 886 new backlinks and 6x first-page keyword positions.
                </p>
              ...
              <div className="bg-white/[0.04] backdrop-blur-sm border border-white/10 rounded-2xl p-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <p className="text-3xl font-bold text-white">1,025%</p>
                    <p className="text-gray-400 text-sm mt-1">Traffic Growth</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-white">60 &rarr; 71</p>
                    <p className="text-gray-400 text-sm mt-1">Domain Rating</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-white">+886</p>
                    <p className="text-gray-400 text-sm mt-1">New Backlinks</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-white">12,600</p>
                ...
                <div className="pt-4 border-t border-white/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white text-sm font-medium">Consistent growth since Sep 2020</p>
                      <p className="text-gray-500 text-xs">Compounding results over 3+ years</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group relative bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300">
                ...
                <p className="text-gray-400 text-sm mt-2">+18% authority increase</p>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-gray-900">593</span>
                ...
                <p className="text-gray-400 text-sm mt-2">355% domain growth</p>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-gray-900">2.2K</span>
                ...
                <p className="text-gray-400 text-sm mt-2">1,025% monthly increase</p>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-gray-900">4,300</span>
                ...
                <p className="text-gray-400 text-sm mt-2">193% keyword expansion</p>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300">
                ...
                <p className="text-gray-400 text-sm mt-2">6.3x first-page keywords</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                ...
                <svg viewBox="0 0 800 280" className="w-full h-auto" role="img" aria-label="Traffic growth chart showing organic traffic rising from 2,200 to 25,100 monthly visits between September 2020 and January 2024">
                  {/* Grid lines */}
                  ...
                  <text x="50" y="191" textAnchor="end" className="text-[11px]" fill="#9ca3af">8K</text>
                  <text x="50" y="139" textAnchor="end" className="text-[11px]" fill="#9ca3af">16K</text>
                  <text x="50" y="86" textAnchor="end" className="text-[11px]" fill="#9ca3af">24K</text>
                  <text x="50" y="34" textAnchor="end" className="text-[11px]" fill="#9ca3af">32K</text>

                  {/* X-axis labels */}
                  <text x="80" y="260" textAnchor="middle" className="text-[11px]" fill="#9ca3af">Sep 2020</text>
                  <text x="200" y="260" textAnchor="middle" className="text-[11px]" fill="#9ca3af">May 2021</text>
                  <text x="320" y="260" textAnchor="middle" className="text-[11px]" fill="#9ca3af">Jan 2022</text>
                  <text x="440" y="260" textAnchor="middle" className="text-[11px]" fill="#9ca3af">Sep 2022</text>
                  <text x="560" y="260" textAnchor="middle" className="text-[11px]" fill="#9ca3af">May 2023</text>
                  <text x="680" y="260" textAnchor="middle" className="text-[11px]" fill="#9ca3af">Jan 2024</text>
                  ...
                  <path
                    d="M80,234 L130,232 L180,228 L230,225 L280,218 L320,210 L360,195 L400,180 L440,160 L480,140 L520,118 L560,100 L600,88 L640,78 L680,72 L720,68 L760,60 L760,240 L80,240 Z"
                    fill="url(#trafficGrad)"
                  />
                  {/* Orange traffic line */}
                  <path
                    d="M80,234 L130,232 L180,228 L230,225 L280,218 L320,210 L360,195 L400,180 L440,160 L480,140 L520,118 L560,100 L600,88 L640,78 L680,72 L720,68 L760,60"
                    fill="none"
                    stroke="#f97316"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  <path
                    d="M80,226 L130,224 L180,222 L230,218 L280,212 L320,204 L360,190 L400,175 L440,158 L480,148 L520,138 L560,128 L600,118 L640,110 L680,105 L720,100 L760,95 L760,240 L80,240 Z"
                    fill="url(#kwGrad)"
                  />
                  {/* Blue keywords line */}
                  <path
                    d="M80,226 L130,224 L180,222 L230,218 L280,212 L320,204 L360,190 L400,175 L440,158 L480,148 L520,138 L560,128 L600,118 L640,110 L680,105 L720,100 L760,95"
                    fill="none"
                    stroke="#3b82f6"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  {/* Endpoint dots */}
                  <circle cx="760" cy="60" r="5" fill="#f97316" />
                  <circle cx="760" cy="95" r="5" fill="#3b82f6" />

                  {/* Label at end */}
                  <rect x="685" y="38" width="58" height="20" rx="4" fill="#f97316" />
                  <text x="714" y="52" textAnchor="middle" className="text-[10px]" fill="white" fontWeight="600">25.1K</text>
                  <rect x="685" y="76" width="58" height="20" rx="4" fill="#3b82f6" />
                  <text x="714" y="90" textAnchor="middle" className="text-[10px]" fill="white" fontWeight="600">12.6K</text>

                  {/* Start marker */}
                  <circle cx="80" cy="234" r="4" fill="#f97316" opacity="0.5" />
                  <circle cx="80" cy="226" r="4" fill="#3b82f6" opacity="0.5" />
                </svg>
                <p className="text-center text-gray-400 text-xs mt-4">
                  Organic traffic and keyword rankings since campaign commencement in September 2020, showing consistent upward trajectory.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-10 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-start gap-4 bg-blue-50 border border-blue-100 rounded-2xl p-6 md:p-8">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-lg mb-2">About Keyfactor</h3>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5 text-gray-600 text-base leading-relaxed">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 md:p-8">
                <p className="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-4">Starting Position — September 2020</p>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4">
                    <div className="w-2 h-2 rounded-full bg-gray-400 flex-shrink-0" />
                    <div>
                      <p className="text-gray-900 font-semibold">~2,200 visits/mo</p>
                  ...
                  <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4">
                    <div className="w-2 h-2 rounded-full bg-gray-400 flex-shrink-0" />
                    <div>
                      <p className="text-gray-900 font-semibold">DR 60</p>
                  ...
                  <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4">
                    <div className="w-2 h-2 rounded-full bg-gray-400 flex-shrink-0" />
                    <div>
                      <p className="text-gray-900 font-semibold">4,300 keywords</p>
                  ...
                  <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4">
                    <div className="w-2 h-2 rounded-full bg-gray-400 flex-shrink-0" />
                    <div>
                      <p className="text-gray-900 font-semibold">269 in top 10</p>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 mt-3 max-w-2xl mx-auto">We built a multi-layered SEO strategy tailored to Keyfactor&apos;s competitive landscape, with four interconnected pillars creating compounding momentum.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="relative bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100 p-6 md:p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  In-depth analysis of Keyfactor&apos;s keyword landscape, mapping existing rankings against competitor positions. We identified high-volume, high-intent keyword gaps and built a targeted roadmap that guided every optimization.
                </p>
              </div>
              ...
              <div className="relative bg-gradient-to-br from-indigo-50 to-white rounded-2xl border border-indigo-100 p-6 md:p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Comprehensive content audits with restructured title tags, meta descriptions, header hierarchies, and internal linking. New SEO-optimized content targeting keyword gaps, built with genuine cybersecurity expertise aligning with E-E-A-T signals.
                </p>
              </div>
              ...
              <div className="relative bg-gradient-to-br from-violet-50 to-white rounded-2xl border border-violet-100 p-6 md:p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Strategic link acquisition from high-authority domains in technology and security verticals. Every link earned through legitimate outreach with carefully managed anchor text distribution, adding 886 new backlinks and growing referring domains from 593 to 2,700.
                </p>
              </div>
              ...
              <div className="relative bg-gradient-to-br from-emerald-50 to-white rounded-2xl border border-emerald-100 p-6 md:p-8">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Detailed technical audits to resolve crawlability and indexation issues. Site speed optimization, broken link fixes, crawl budget allocation, and Core Web Vitals improvements — ensuring the technical foundation could support growing traffic.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 md:p-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    ...
                    <span className="text-white font-semibold">~2,200/mo</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    ...
                    <span className="text-white font-semibold">4,300</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    <span className="text-gray-400">Top 10 Positions</span>
                    <span className="text-white font-semibold">269</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    <span className="text-gray-400">Referring Domains</span>
                    <span className="text-white font-semibold">593</span>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    ...
                    <div className="text-right">
                      <span className="text-white font-semibold">25,100/mo</span>
                      <span className="ml-2 text-emerald-400 text-sm font-medium">+1,025%</span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    <span className="text-gray-400">Domain Rating</span>
                    <div className="text-right">
                      ...
                      <span className="ml-2 text-emerald-400 text-sm font-medium">+18%</span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    <span className="text-gray-400">Organic Keywords</span>
                    <div className="text-right">
                      <span className="text-white font-semibold">12,600</span>
                      <span className="ml-2 text-emerald-400 text-sm font-medium">+193%</span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    <span className="text-gray-400">Top 10 Positions</span>
                    <div className="text-right">
                      ...
                      <span className="ml-2 text-emerald-400 text-sm font-medium">+532%</span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-white/5">
                    <span className="text-gray-400">Referring Domains</span>
                    <div className="text-right">
                      <span className="text-white font-semibold">2,700</span>
                      <span className="ml-2 text-emerald-400 text-sm font-medium">+355%</span>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-400">Backlinks</span>
                    <div className="text-right">
                      <span className="text-white font-semibold">+886</span>
            ...
            <div className="space-y-6 text-gray-600 text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-500 bg-blue-50 rounded-r-2xl py-5 px-6">
                <p className="text-gray-800 font-medium text-lg leading-relaxed italic">
                  &ldquo;The 1,025% traffic increase was not a spike — it was the result of compounding improvements across every dimension of search performance.&rdquo;
                </p>
              </div>
              ...
              <p>
                Because the strategy was built on sustainable practices — high-quality content, earned backlinks from authoritative domains, and a technically sound site foundation — those gains are durable. They continue to compound as Keyfactor&apos;s authority grows.
              </p>

              <p>
                This is the kind of outcome that happens when you treat SEO not as a set of isolated tactics but as an integrated growth strategy. DiamondLinks builds every campaign with this principle at its core.
              </p>
            </div>
